...
function calculateCustom() {
  ...
  // Calculate weighted parameters for the ones with weight sliders:
  ...
  // For simplicity, combine the weighted inputs into a composite value Q_custom.
  // (This formula can be adjusted to your needs.)
      ...
      options: {
        ...
        scales: {
          ...
          y: {
            ...
            ticks: { stepSize: 1 }  // More detailed y-axis ticks
          }
        }
      }
    });
